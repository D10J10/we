 ...
 */
public abstract class DmBaseChangeRecordEmitter<T> extends RelationalChangeRecordEmitter {

    protected final Table table;

    protected DmBaseChangeRecordEmitter(OffsetContext offset, Table table, Clock clock) {
        super(offset, clock);
        this.table = table;
    }
