 ...
 */
public class DmSnapshotChangeEventSource extends RelationalSnapshotChangeEventSource {
    ...
    public DmSnapshotChangeEventSource(DmConnectorConfig connectorConfig, OracleOffsetContext previousOffset, DmConnection jdbcConnection,
    ...
    private Scn getCurrentScn(SnapshotContext ctx) throws SQLException {
        if (connectorConfig.getAdapter().equals(DmConnectorConfig.ConnectorAdapter.LOG_MINER)) {
            return DmLogMinerHelper.getCurrentScn(jdbcConnection);
        }
    ...
    protected Optional<String> getSnapshotSelect(RelationalSnapshotContext snapshotContext, TableId tableId) {
        final DmOffsetContext offset = (DmOffsetContext) snapshotContext.offset;
     ...
     */
    private static class DmSnapshotContext extends RelationalSnapshotContext {
