 ...
 */
public class DmParserUtils {

    private DmParserUtils() {
    }
     ...
     */
    public static void cloneOldToNewColumnValues(Map<String, DmLogMinerColumnValueWrapper> newColumnValues, Map<String, DmLogMinerColumnValueWrapper> oldColumnValues,
                                                 Table table) {
        for (Column column : table.columns()) {
            final DmLogMinerColumnValueWrapper newColumnValue = newColumnValues.get(column.name());
            if (!newColumnValue.isProcessed()) {
                final DmLogMinerColumnValueWrapper oldColumnValue = oldColumnValues.get(column.name());
