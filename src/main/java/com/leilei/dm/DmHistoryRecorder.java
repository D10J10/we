 ...
 */
@Incubating
public interface DmHistoryRecorder extends AutoCloseable {
    /**
     ...
     */
    void prepare(StreamingChangeEventSourceMetrics streamingMetrics, JdbcConfiguration jdbcConfiguration, long retentionHours);
