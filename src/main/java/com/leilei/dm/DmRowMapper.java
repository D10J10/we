 ...
 */
public class DmRowMapper {

    private static final Logger LOGGER = LoggerFactory.getLogger(DmRowMapper.class);
     ...
     * @return the redo SQL
     */
    public static String getSqlRedo(ResultSet rs, boolean isDml, DmHistoryRecorder historyRecorder, Scn scn, String tableName,
