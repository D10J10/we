...
public class DmOffsetContext implements OffsetContext {
    ...
    private final DmSourceInfo sourceInfo;
    ...
    public DmOffsetContext(DmConnectorConfig connectorConfig, Scn scn, Scn commitScn, LcrPosition lcrPosition,
    ...
    private DmOffsetContext(DmConnectorConfig connectorConfig, Scn scn, LcrPosition lcrPosition,
                            boolean snapshot, boolean snapshotCompleted, TransactionContext transactionContext) {
        partition = Collections.singletonMap(SERVER_PARTITION_KEY, connectorConfig.getLogicalName());

        sourceInfo = new DmSourceInfo(connectorConfig);
    ...
    public static class Loader implements OffsetContext.Loader {
        ...
        private final DmConnectorConfig.ConnectorAdapter adapter;

        // todo resolve adapter from the config rather than passing it
        public Loader(DmConnectorConfig connectorConfig, DmConnectorConfig.ConnectorAdapter adapter) {
            this.connectorConfig = connectorConfig;
        ...
        public OffsetContext load(Map<String, ?> offset) {
            ...
            Scn scn;
            if (adapter ==DmConnectorConfig.ConnectorAdapter.LOG_MINER) {
                ...
                return new DmOffsetContext(connectorConfig, scn, lcrPosition, snapshot, snapshotCompleted, TransactionContext.load(offset));
            }
